...
/**
 * Precompiled com.hansanhha.computer.java script plugin.
 **/
public class ComHansanhhaComputerJavaPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComHansanhhaComputerJava").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComHansanhhaComputerJava").asSubclass(BasicScript.class);
